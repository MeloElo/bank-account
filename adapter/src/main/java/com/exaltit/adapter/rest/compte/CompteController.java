...
public class CompteController {
    ...
    public CompteDTO crediterCompteRest(@RequestParam BigDecimal montant, @RequestParam Long numCompte) {
        return CompteRestMapper.COMPTE_REST_MAPPER.compteDomainModelToDto(compteServicePort.crediterCompte(montant, numCompte));
    }
    ...
    public CompteDTO debiterCompteRest(@RequestParam BigDecimal montant, @RequestParam Long numCompte) {
        return CompteRestMapper.COMPTE_REST_MAPPER.compteDomainModelToDto(compteServicePort.debiterCompte(montant, numCompte));
    }
